...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE documentada set c= '$c', n= '$n', r= '$r', f= '$f', pu= '$pu', e= '$e', p= '$p', pe= '$pe', d= '$d' WHERE id=$id";
...
<link rel="stylesheet" href="style.css">
      ...
      <th><textarea name="c" class="informe" cols="20" rows="4"><?php echo $c;?></textarea></th>
