        ...
        <div class="sb-sidenav-menu">
          ...
          <div class="nav">
            ...
            <div class="collapse" style="color:#323232" id="collapseRecursos" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
              <nav class="sb-sidenav-menu-nested nav">
                <a class="nav-link fw-bold" style="color:#323232" href="index.php">Personal</a>
...
<div>
    ...
    <div>
            ...
            <input type="text" name="nombreArchivo" required><center>
            <h1></h1>
        ...
        <input type = "button" class="forma" value = "¡Regresar!" onclick = "location.href='../../index.php'"> </form>
