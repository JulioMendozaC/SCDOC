...
function editarArchivo($conexion,$id,$categoria,$tipo,$archivoBLOB){
    $sql="UPDATE arcperso SET categoria='$categoria',tipo='$tipo',archivo='$archivoBLOB' WHERE id=$id";
    $query=mysqli_query($conexion,$sql);
    return $query;
}
function editar($conexion,$id,$nombre,$categoria,$tipo,$archivoBLOB){
    $sql="UPDATE arcperso SET nombre='$nombre', categoria='$categoria',tipo='$tipo',archivo='$archivoBLOB' WHERE id=$id";
    $query=mysqli_query($conexion,$sql);
    return $query;
}
