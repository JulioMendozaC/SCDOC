...
if (isset($_POST['update'])) {
  ...
  $query = "UPDATE desempeño set p= '$p', o= '$o', r= '$r', i= '$i', m= '$m', f= '$f', en= '$en', fe= '$fe', ma= '$ma', ab= '$ab', may= '$may', ju= '$ju', jul= '$jul', ag= '$ag', se= '$se', oc= '$oc', nov= '$nov', di= '$di' WHERE id=$id";
...
<link rel="stylesheet" href="style.css">
      ...
      <th><textarea name="nov" class="informedos" cols="20" rows="4"><?php echo $nov;?></textarea></th>
